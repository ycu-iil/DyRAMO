...
def download_rnn_model(conf, logger):
    ...
    if not os.path.exists(path_model_json):
        url = f'https://raw.githubusercontent.com/molecule-generator-collection/ChemTSv2/c61abbc702b914a76e076d87d416cdc67d3fd517/{path_model_json}'
    ...
    if not os.path.exists(path_model_weight):
        ...
        os.makedirs(dirname, exist_ok=True)
        url = f'https://raw.githubusercontent.com/molecule-generator-collection/ChemTSv2/c61abbc702b914a76e076d87d416cdc67d3fd517/{path_model_weight}'
    ...
    if not os.path.exists(path_token):
        ...
        os.makedirs(dirname, exist_ok=True)
        url = f'https://raw.githubusercontent.com/molecule-generator-collection/ChemTSv2/c61abbc702b914a76e076d87d416cdc67d3fd517/{path_token}'
...
def download_filters(conf, logger):
    ...
    for key in filter_keys:
        ...
        if not os.path.exists(f'filter/{filter_name}.py'):
            url = f'https://raw.githubusercontent.com/molecule-generator-collection/ChemTSv2/c61abbc702b914a76e076d87d416cdc67d3fd517/filter/{filter_name}.py'
...
def download_policy(conf, logger):
    ...
    if not os.path.exists('policy/policy.py'):
        url = f'https://raw.githubusercontent.com/molecule-generator-collection/ChemTSv2/c61abbc702b914a76e076d87d416cdc67d3fd517/policy/policy.py'
    ...
    if not os.path.exists(f'policy/{policy_module}.py'):
        url = f'https://raw.githubusercontent.com/molecule-generator-collection/ChemTSv2/c61abbc702b914a76e076d87d416cdc67d3fd517/policy/{policy_module}.py'
